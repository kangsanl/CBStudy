<%@ Page Title="정보" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Final.aspx.cs" Inherits="CBStudy.Final" %>
...
&nbsp;&nbsp;&nbsp; Thank you for the participation 
    ...
    <br /><br />
    &nbsp;&nbsp;&nbsp; Your
    Total Profit : <asp:Label ID="lblTPROFIT" runat="server" Font-Bold="True" Font-Italic="True" 
    ...
    <td valign="bottom"><asp:Label ID="lblTURN" runat="server"></asp:Label></td>
    </tr>
    </table>
    </div>
    <p></p>
